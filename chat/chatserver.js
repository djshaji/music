...
// const certFilePath = "/etc/pki/tls/certs/localhost.crt"
// const keyFilePath = "/etc/pki/tls/private/localhost.key"
const certFilePath = "/etc/letsencrypt/live/music.shaji.in/cert1.pem"
const keyFilePath = "/etc/letsencrypt/live/music.shaji.in/privkey1.pem"
...
try {
  ...
  try {
    ...
    console.log ("Error loading cert:", err);
  }
} catch(err) {
  httpsOptions.key = null;
  httpsOptions.cert = null;
