...
<footer class="footer">
  <div class="container">
    <div class="row row-grid align-items-center mb-5">
      <div class="col-lg-6">
        <h3 class="text-primary font-weight-light mb-2">Thank you for visiting!</h3>
    ...
    <div class="row align-items-center justify-content-md-between">
      <div class="col-md-6">
        <div class="copyright">
          &copy; Copyleft 2020 <a href="" target="_blank">Shaji</a>.
        </div>
      </div>
      <div class="col-md-6">
...
<script>
    ...
    var winamp = new Webamp({})
</script>  

<div style="visibility:hidden;position:fixed;right:20px;bottom:10px;z-index:1000"
  id="winamp_show">
  <a href="javascript: scrollto_winamp ()">
    <img width="48" src="/assets/img/winamp.png"/>
  </a>
</div>
